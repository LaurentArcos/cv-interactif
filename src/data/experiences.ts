...
export const experiences: Experience[] = [
  ...
  },
  {
    ...
    descriptionEn: `
      ...
      - Creation of custom React web applications.

      - Development of various projects, including internal tools and custom APIs.
  ...
  },
  {
    ...
    descriptionEn: `
      ...
      - Managed client portfolios and prospected new partners.

      - Presented collections, negotiated budgets, and entered orders in the showroom.

      - Defined sales targets and monitored performance for both personal and client metrics.

      - Hosted remote client meetings (overseas territories).

      - Created and managed promotional campaigns to boost sales.

      - Coordinated deliveries and customer payments with logistics and accounting teams.
    `,
  ...
  },
  {
    ...
    descriptionEn: `
      ...
      - Assisted clients with restock orders and special promotions.

      - Analyzed and reported on order and delivery data.
    `,
  ...
  },
  {
    ...
    dateFr: "Mars 2008 - Janvier 2011",
    dateEn: "March 2008 - January 2011",
